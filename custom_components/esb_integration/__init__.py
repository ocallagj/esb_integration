"""
Custom integration to integrate esb_integration with Home Assistant.

For more details about this integration, please refer to
https://github.com/ocallagj/esb_integration
"""
...
from .data import IntegrationESBData
...
async def async_setup_entry(
    ...
    entry.runtime_data = IntegrationESBData(
