"""Binary sensor platform for esb_integration."""
...
class IntegrationESBBinarySensor(IntegrationESBEntity, BinarySensorEntity):
    """esb_integration binary_sensor class."""
